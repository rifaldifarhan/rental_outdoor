                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                      ...
                      //  $totalbiaya=$r[jmlsewa]*$r[hargasewa]*$r[lamasewa];
                        ...
                        <td><a href="?pg=trs&act=delete&id=<?php echo $r['idtransaksi']?>"><button type="button" class="btn btn-success" onclick="return confirm('Apakah anda yakin akan menghapusnya?');">Hapus</button></a></td>
                        </tr>
                        </tr>
