...
<html>
  ...
  <body>
    ...
    <a href="?pg=tambah_produk" class="btn btn-info">Tambah Alat</a>
    ...
    <tbody>
      ...
      ?>
       <tr>
          ...
          <td>
              &nbsp;
              <a href="edit_produk.php?idalat=<?php echo $row['idalat']; ?>" class="btn btn-info">Edit</a>
             <a href="proses_hapus.php?idalat=<?php echo $row['idalat']; ?>"class="btn btn-success" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
