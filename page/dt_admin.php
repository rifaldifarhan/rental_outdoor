...
<section class="content">
    ...
    <center><a href="?pg=adm&act=add"> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Data </i></button> </a></center>
    </div><!-- /.box-header -->
              ...
              <div class="box box-info">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $tampil=mysqli_query($koneksi,"SELECT * FROM tbladmin order by idadmin asc");
                    $no = 1;
                    ...
                    ?>
                        ...
                        <td><a href="?pg=adm&act=delete&id=<?php echo $r['idadmin']?>"><button type="button" class="btn btn-success" onclick="return confirm('Apakah anda yakin akan menghapusnya?');">Hapus</button></a></td>
                        </tr>
    ...
    <!-- /.row (main row) -->
      ...
      case 'add':
      if (isset($_POST['add'])) {
                $query = mysqli_query($koneksi,"INSERT INTO tbladmin VALUES ('','$_POST[username]',
...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbladmin WHERE idadmin='$_GET[id]'"));
            if (isset($_POST['update'])) {

            if (empty($_POST[password])) {

                mysqli_query($koneksi,"UPDATE tbladmin SET username='$_POST[username]',
                  status='$_POST[status]'
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA PENGGUNA //
      case 'delete':
      mysqli_query($koneksi,"DELETE FROM tbladmin WHERE idadmin='$_GET[id]'");
      echo "<script>window.location='home.php?pg=adm&act=view'</script>";
      break;
